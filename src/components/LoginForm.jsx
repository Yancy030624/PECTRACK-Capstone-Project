  ...
  return (
    <div className="min-h-142.5 bg-[#fffedc] p-7 sm:p-10 md:p-12">
      ...
      {pendingOtp ? (
        ...
        <>
          <div className="mt-6 md:mt-8"><span className="rounded-full bg-lime-200 px-3 py-1.5 text-[10px] font-bold text-green-800">Customer Login</span><h2 id="login-heading" className="mt-3 text-3xl font-extrabold leading-[1.05] text-brand-700">Sign in to your<br />account</h2><p className="mt-2 text-[11px] font-medium text-stone-500">Use your username or email to continue</p></div>
